...
public class MirrorCameraHorizontalSinEffect : MonoBehaviour
{
    ...
    private void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        float realAmplitude = _amplitude * 0.1f / yRatio;
        ...
        float realFrequency = _frequency * xRatio;
        ...
        float realPhase = (_phase - (_mirrorCamera.PositionChangeRatioX - xRatio * 0.5f + 0.5f)) / xRatio;
